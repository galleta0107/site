...
<head>
    ...
    <script>
        function redirigirPorGeolocalizacion() {
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(function(position) {
                    ...
                    // Calcular la distancia entre el usuario y la ubicación específica
                    var distancia = calcularDistancia(latitudUsuario, longitudUsuario, latitudObjetivo, longitudObjetivo);

                    // Redirigir si la distancia es menor o igual a 100 metros
                    if (distancia <= 100) {
                        window.location.href = "https://forms.gle/qWntF4Tb2UxEzouaA";
                    } else {
                        window.location.href = "https://forms.gle/qWntF4Tb2UxEzouaA";
                    }
                });
        ...
        function calcularDistancia(lat1, lon1, lat2, lon2) {
            ...
            var distancia = R * c; // Distancia en metros
            return distancia;
        }
    </script>
</head>
